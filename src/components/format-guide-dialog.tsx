...
export function FormatGuideDialog({ trigger }: FormatGuideDialogProps) {
  ...
  function handleDownload() {
    if (activeTab === 'csv') {
      downloadFile(EXAMPLE_CSV, 'exemple-tripbrain.csv', 'text/csv;charset=utf-8')
    } else {
      downloadFile(EXAMPLE_JSON, 'exemple-tripbrain.json', 'application/json')
    }
  }
      ...
      <DialogContent className="flex max-h-[85vh] flex-col gap-0 p-0 sm:max-w-2xl">
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-6 pb-4">
            ...
            {/* ────────────────── CSV TAB ────────────────── */}
            <TabsContent value="csv" className="mt-0 space-y-4 pt-2">
              ...
              {/* Sections by type — Accordion, none open by default */}
            ...
            {/* ────────────────── JSON TAB ────────────────── */}
            <TabsContent value="json" className="mt-0 space-y-4 pt-2">
              <p className="text-muted-foreground text-sm">
              ...
              {/* JSON structure — Accordion, none open by default */}
              <Accordion type="multiple" defaultValue={[]} className="w-full">
